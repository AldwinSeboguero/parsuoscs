...
class CashierController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            $cashiers =  new CashierCollection(Staff::orderByDesc('updated_at')->where('designee_id',
    ...
    { 
            ...
            $staff->save(); 
            $staffs =  new CashierCollection(Staff::orderByDesc('updated_at')->where('designee_id',
            Designee::where('name','Cashier')->first()->id)->with('user')->with('semester')->with('designee')->with('campus')
            ->paginate(5));
            return response()->json(['cashiers'=>$staffs,200]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['cashier'=> new StaffResource($staff)],200);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['cashier' => $staff],200);
    } 
