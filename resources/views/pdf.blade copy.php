...
<html lang="en">
	...
	<body>
		...
		<table>
			...
			<tbody>
				@if($clearance->cashier == 1
				&& $clearance->student_council == 1
				&& $clearance->library == 1
				&& $clearance->osas == 1
				&& $clearance->program_director == 1
				&& $clearance->college_deaan == 1
				&& $clearance->registrar == 1
				)
				...
				&& $clearance->library == 1
				&& $clearance->osas == 1
				&& $clearance->program_director == 0
				&& $clearance->college_deaan == 1
				&& $clearance->registrar == 0
				)
				<tr>
					<td>Cashier</td>
					<td style="padding-left:20px;"> {{$staffCASHIER->user->name}}</td>
