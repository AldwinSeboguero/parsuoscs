<template>
  <v-app id="inspire">
          ...
          <template v-for="item in items">
            ...
            >
              <template v-slot:activator>
                ...
                <v-list-item-content>
                  <v-list-item-title
                    class="caption white--text text--darken-4 font-weight-light"
                  >
                    {{ item.text }}
                  </v-list-item-title>
                </v-list-item-content>
                <v-list-item-action style="margin-right: 10px">
                  <v-icon>{{
                    item.model ? "mdi-chevron-up" : item["icon-alt"]
                  }}</v-icon>
                </v-list-item-action>
              </template>
              <v-list-item
              ...
              >
                ...
                <v-list-item-content style="padding-left: 20px">
                  <v-list-item-title
                    class="caption white--text text--darken-2 font-weight-light"
                  >
                    {{ child.text }}
                  </v-list-item-title>
                </v-list-item-content>
    ...
    <v-app-bar app outlined class="white" height="50" elevation="1">
      <v-app-bar-nav-icon
      ...
      <v-btn icon small class="mr-2">
        <v-badge bordered overlap content="0" small dot>
...
export default {
  ...
  created() {
    ...
    axios.get("/api/v1/getUser").then((res) => {
