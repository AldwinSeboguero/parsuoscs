    ...
    >
      ...
      <template v-slot:item.actions="{ item }" v-if="stad">
        <template v-if="item.status == 0 && item.designee">
          <template v-if="item.clearanceRequestCount == 0 && item.deficiencyCount == 0">
            <v-btn
              class="ma-2"
              color="primary"
              depressed
          ...
          this.clearances = [
            {
              ...
              designee: res.data.signatoryNameclearanceRequestSTCOUNCIL
                ? res.data.signatoryNameclearanceRequestSTCOUNCIL.name
                : null,
              ...
              clearanceRequestCount: res.data.countClearanceRequestSTCOUNCIL
                ? 1
                : 0,
