  ...
  data: () => ({
    ...
    items: [
      ...
      },
      {
        ...
        model: false,
        children: [
          { text: "CAS", link: "/osas/goa/clearance/requests/cas" },
          { text: "CBM", link: "/osas/goa/clearance/requests/cbm" },
          { text: "CET", link: "/osas/goa/clearance/requests/cet" },
          { text: "COED", link: "/osas/goa/clearance/requests/coed" }, 
          { text: "SGS", link: "/osas/goa/clearance/requests/sgs" },
        ],
      },
      {
      ...
      { icon: "mdi-cog", text: "Settings", link: "/osas/goa/settings" }, 
    ],
  }),
  watch: {
    dialog(val) {
