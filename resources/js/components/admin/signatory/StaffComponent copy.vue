    ...
    <v-container class="grey lighten-5" fluid>
     <v-row wrap>
       <v-col cols="12" lg="12">
           ...
           <h1
                        class="title desplay-2 white--text text--accent3"
                       
                      >
                      <v-icon class="ma-1 white--text">mdi-account-plus-outline</v-icon>
                        Add Staff
                        <v-dialog
                         v-model="copyDialog"
        ...
        <v-list-item three-line style="background: linear-gradient(to left, #1A237E, #1A237E, #0D47A1);">
          <v-list-item-content > 
